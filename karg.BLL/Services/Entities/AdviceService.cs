    ...
    public class AdviceService : IAdviceService
    {
        ...
        public async Task<CreateAndUpdateAdviceDTO> CreateAdvice(CreateAndUpdateAdviceDTO adviceDto)
        {
            try
            {
                ...
                adviceDto.Images = await _imageService.UploadImages(nameof(Advice), adviceId, adviceDto.Images, false);
        ...
        public async Task<CreateAndUpdateAdviceDTO> UpdateAdvice(int adviceId, JsonPatchDocument<CreateAndUpdateAdviceDTO> patchDoc)
        {
            try
            {
                ...
                {
                    patchedAdvice.Images = await _imageService.UploadImages(nameof(Advice), adviceId, patchedAdvice.Images, true);
                }
